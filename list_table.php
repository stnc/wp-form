...
class TT_Example_List_Table extends WP_List_Table {
    ...
    function __construct(){
       ...
       echo  $query = " SELECT id,name_,lastname_,mail_adress	FROM  " . esc_sql($wpdb->prefix . 'stnc_gonulluol') ;
    
        $this->my_data = $wpdb->get_results($query);

       // print_r( $wpdb->get_results($query) ); //Show the whole array for troubleshooting purposes
       //  print_r( $example_data ); //Show the whole array for troubleshooting purposes

      // print_r($this->my_data  ); //Show the whole array for troubleshooting purposes
       $this->my_data =  objectToArray( $this->my_data ); //$this->example_data;
    ...
    function get_sortable_columns() {
        $sortable_columns = array(
            ...
            'mail_adress'    => array('mail_adress',false),
