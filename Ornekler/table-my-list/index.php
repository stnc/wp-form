		...
		if ( 'delete' === $this->current_action() ) {
			...
			if ( ! wp_verify_nonce( $nonce, 'sp_delete_customer' ) ) {
				...
				self::delete_customer( absint( $_GET['customer'] ) );
		                ...
		                wp_redirect( "http://summit.test/wp-admin/admin.php?page=wp_list_table_class" );
				exit;
			}
...
// echo "load-$hook";
	...
	public function plugin_settings_page() {
		...
		?>
		<div class="wrap">
			<h2>WP_List_Table Class Example veri</h2>

			<div id="poststuff">
				<div id="post-body2" class="metabox-holder columns-2">
